...
public class LoginController {
	...
	@RequestMapping(value = "/test/login.do", method = { RequestMethod.GET, RequestMethod.POST })
	public ModelAndView login2(@RequestParam("userID") String userID,  //String 지정 형식을 어노테이션 형식으로 바꿈.
	...
	public ModelAndView login2(@RequestParam("userID") String userID, 
			                   ...
			                   @RequestParam(value="userEmail", required=true) String userEmail, //true false차이
			                  HttpServletRequest request, HttpServletResponse response) throws Exception {
		request.setCharacterEncoding("utf-8");
		ModelAndView mav = new ModelAndView();
		mav.setViewName("result");
